...
void App::OnSuspending(Object^ sender, SuspendingEventArgs^ e)
{
	...
	// Crie o conteúdo da notificação em XML
	XmlDocument^ toastXml = ToastNotificationManager::GetTemplateContent(ToastTemplateType::ToastText02);

	XmlNodeList^ textNodes = toastXml->GetElementsByTagName("text");
	textNodes->Item(0)->AppendChild(toastXml->CreateTextNode("Aplicativo suspenso"));
	textNodes->Item(1)->AppendChild(toastXml->CreateTextNode("O aplicativo foi suspenso."));

	// Crie e mostre a notificação
